...
keymap.set("n", "<leader>sdv", "<cmd>vsp<CR>", { desc = "Split window vertically with the same file" })
keymap.set("n", "<leader>sdh", "<cmd>sp<CR>", { desc = "Split window horizontally with the same file" })
...
-- <leader>bd is defined in snacks.lua (deletes buffer without closing split)
